...
PAGES = [
    dict(path="metodicka-podpora/index.html", title="Metodická podpora", section="metodicka-podpora",
         ...
         body=ROZCESTNIK),
    dict(path="metodicka-podpora/metodicka-stanoviska.html", title="Metodická stanoviska a výklady",
         ...
         body=STANOVISKA),
    dict(path="metodicka-podpora/stanovisko-detail.html", title="Detail metodického stanoviska",
         ...
         body=DETAIL),
    dict(path="metodicka-podpora/caste-dotazy.html", title="Časté dotazy — stavební úřady",
         section="metodicka-podpora", crumbs=C + [("Časté dotazy", None)], h1="Časté dotazy", body=FAQ_SU),
    dict(path="metodicka-podpora/caste-dotazy-dotcene-organy.html", title="Časté dotazy — dotčené orgány",
    ...
    dict(path="metodicka-podpora/caste-dotazy-uzemni-planovani.html", title="Časté dotazy — úřady územního plánování",
    ...
    dict(path="metodicka-podpora/prechodove-obdobi.html", title="Přechodové období", section="metodicka-podpora",
         ...
         body=PRECHOD),
    dict(path="metodicka-podpora/standardizace.html", title="Standardizace územního plánování",
    ...
    dict(path="metodicka-podpora/tisic-otazek.html", title="Tisíc otázek ke stavebnímu právu",
         section="metodicka-podpora", crumbs=C + [("Tisíc otázek ke stavebnímu právu", None)],
         h1="Tisíc otázek ke stavebnímu právu", body=TISIC),
    dict(path="metodicka-podpora/tisic-otazek-seznam.html", title="Tisíc otázek — seznam hesel",
         section="metodicka-podpora",
